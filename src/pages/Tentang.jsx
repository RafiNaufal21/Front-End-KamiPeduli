                ...
                <div class="team-text bg-light text-center p-4">
                 <h5>Rafi Naufal Y. R.</h5>
                  ...
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/RafiNaufal21">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.linkedin.com/in/rafi-naufal/">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.instagram.com/rafinaufal_y.r/">
            ...
            >
              <div className="team-item position-relative rounded overflow-hidden">
                ...
                <div className="team-text bg-light text-center p-4">
                  ...
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/devisamosir">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="http://linkedin.com/in/devi-samosir-314328289/">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.instagram.com/xyhnas/">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
            ...
            >
              <div className="team-item position-relative rounded overflow-hidden">
                ...
                <div className="team-text bg-light text-center p-4">
                  ...
                  <p className="text-primary">Hipster</p>
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/alfianasuci">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.linkedin.com/in/alfiana-suci-handayani-77528a228">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://instagram.com/alfianasuci?igshid=NzZlODBkYWE4Ng">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
            ...
            >
              <div className="team-item position-relative rounded overflow-hidden">
                ...
                <div className="team-text bg-light text-center p-4">
                  ...
                  <p className="text-primary">Hipster</p>
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/Rifqi0205">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.linkedin.com/in/rifqi-nanda-128670243">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://instagram.com/_rifqi_1496">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
            ...
            >
              <div className="team-item position-relative rounded overflow-hidden">
                ...
                <div className="team-text bg-light text-center p-4">
                  ...
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/fatickhy">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="http://www.linkedin.com/in/vio-fatickhy">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://instagram.com/fatickhy?igshid=YTQwZjQ0NmI0OA">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
            ...
            >
              <div className="team-item position-relative rounded overflow-hidden">
                ...
                <div className="team-text bg-light text-center p-4">
                  ...
                  <p className="text-primary">Hacker</p>
                  <div className="team-social text-center">
                    <a className="btn btn-square" href="https://github.com/tedycoeg">
                      <i className="fab fa-github"></i>
                    </a>
                    <a className="btn btn-square" href="http://www.linkedin.com/in/tedy-ariadi-gultom">
                      <i className="fab fa-linkedin"></i>
                    </a>
                    <a className="btn btn-square" href="https://www.instagram.com/tedy_zzz/">
                      <i className="fab fa-instagram"></i>
                    </a>
                  </div>
                </div>
